...
The original data from Kaggle Machine Learning Competitions had xx variables with xx observations. For this project, we have cleaned the dataset leaving us with xx variables and xx observations. 
...
```{r}
    ...
    test_X = fread("./test_X.csv")
    test_y = fread("./train_y.csv")
...
# Data Exploration
The purpose of data exploration was to figure out interesting facts about the dataset. 
