...
From this exploration, it was possible to see that the top 34 teams with the highest % of games won are one of the most frequent teams playing at NCAA March Madness. For instance, Vilanova won in 2018 and it is one of the top 34 teams. Duke is also very strong team, always making it to the Elite Eight most of the seasons. 
...
## Winning Probability by Game Statistics

Also, by exploring different game statistics that could be engineered further down the analysis, we can figure out which game statistics affect the result of the match. Game statistics are those that may contribute to the probability of winning. Points scores in game (pts), number of assists (ast), number of steals (stl) and number of blocks (blk) are some of the examples of "game statistics" in this report. 
