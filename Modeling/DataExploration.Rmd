...
Are the same winners always winning? What were the top/least scoring teams across all seasons? March Madness involves 68 Teams in total, so let's see who are top/worst 34 teams. 
...
head(final_frequency[order(-final_frequency$percentage),], n=34)
